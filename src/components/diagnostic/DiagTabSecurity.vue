...
import { CheckCircle, AlertTriangle, XCircle, ShieldCheck, ShieldOff } from "lucide-vue-next";
...
<template>
  ...
  <template v-if="tab === 'security'">
    ...
    <template v-else>
      ...
      <p class="diag-section-label">Démarrage sécurisé & Virtualisation</p>
      ...
      <p class="diag-section-label">Antivirus & Defender</p>
      <div class="diag-section">
        <div class="diag-badge-row">
      ...
      <p class="diag-section-label">Contrôle & Accès</p>
      <div class="diag-section">
        <div class="diag-badge-row">
      ...
      <template v-if="securityInfo.bitlocker_drives.length > 0">
        <p class="diag-section-label">BitLocker — {{ securityInfo.bitlocker_drives.length }} volume(s)</p>
  ...
  <template v-else-if="tab === 'license'">
    <div v-if="licenseInfo">
      <p class="diag-section-label">Licence Windows</p>
      ...
      <template v-if="licenseInfo.office_name">
        <p class="diag-section-label">Microsoft Office / 365</p>
        <div class="info-grid">
